...
<div><h4>>> 근태코드등록</h4></div><br><br>

<div>
<table border= '1' cellspacing='1' cellpadding='0'>
<tr height = '20' style = "background: #D9E5FF;">
	<th width = '150'>근태코드</th>
	<th width = '150'>근태명칭</th>
	<th width = '150'>휴가코드관리여부</th>
	<th width = '150'>사용</th>

	<%
	for(Commute_codeEntity pb1 : (ArrayList<Commute_codeEntity>)list_com_code) {
%>
	<tr align = center>
	<td><%=pb1.getCom_id() %></td>
	<td><%=pb1.getCom_name() %></td>
	<td><%=pb1.getHoliday_yn() %></td>
	<td>yes</td>
